...
import { compactButtonVariants } from "@ui/components/compact-button";
      ...
      components={{
        Chevron: (props) => {
          if (props.orientation === "left") {
            ...
            return <RiArrowLeftSLine className="size-5" {...props} />;
          }

          // @ts-expect-error - conflit with react 19
          return <RiArrowRightSLine className="size-5" {...props} />;
        },
      }}
      {...rest}
    />
